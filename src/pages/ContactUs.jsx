...
export default function ContactUs() {
  ...
  function ContactCard({ type }) {
    ...
    const waMsg = encodeURIComponent(
      `Hello, I would like to book an appointment at ${name}.`
    );
          ...
          >
            <img
              ...
              onError={(e) => {
                ...
                e.target.parentElement.innerHTML = `<span style="font-size:24px">${
                  isHomeo ? '🌿' : '🥗'
                }</span>`;
              }}
            />
          </div>
          <h3 style={{ fontSize: 17, fontWeight: 800, color: theme.accent }}>
            {name}
          </h3>
        </div>
